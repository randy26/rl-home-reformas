...
function App() {
  ...
  return <div className="app">
    ...
    <main>
      ...
      <section className="info-section" id="contacto"><div className="container info-grid"><div className="info-card"><Mail size={22}/><h3>Contacto editorial</h3><p>Para consultas, colaboraciones o propuestas relacionadas con el contenido de RL Home & Reformas.</p><small>Escríbenos para consultas editoriales, colaboraciones o propuestas sobre reformas y mejora del hogar.</small></div><div className="info-card"><Info size={22}/><h3>Afiliación transparente</h3><p>Los enlaces de afiliación se identifican y no implican un coste adicional para quien compra.</p></div><div className="info-card"><Ruler size={22}/><h3>Información de producto</h3><p>Los datos comerciales pueden cambiar. La información vigente será siempre la mostrada por la tienda de destino.</p></div></div></section>

      <section className="legal-section" id="legal"><div className="container legal-grid"><article id="aviso-legal"><FileText size={20}/><h3>Aviso legal</h3><p><strong>Titular:</strong> Randy Paredes Lecca</p><p><strong>Email:</strong> <a href="mailto:randylecca86@gmail.com">randylecca86@gmail.com</a></p><p><strong>Identificación fiscal:</strong> No publicada en este sitio.</p><p>RL Home & Reformas es un proyecto editorial independiente. Para cuestiones legales o relacionadas con el sitio, puedes contactar con el titular mediante el correo indicado.</p></article><article id="privacidad"><ShieldCheck size={20}/><h3>Privacidad</h3><p>La política definitiva debe indicar qué datos personales se recogen, finalidad, base jurídica, conservación y derechos de las personas usuarias, adaptándose a las herramientas realmente instaladas.</p></article><article id="cookies"><Cookie size={20}/><h3>Cookies</h3><p>La política de cookies debe reflejar las herramientas realmente utilizadas. Si se incorporan analítica, publicidad o tecnologías no necesarias, deberá actualizarse y aplicarse el consentimiento que corresponda.</p></article><article id="afiliacion"><Tag size={20}/><h3>Enlaces de afiliación</h3><p>Algunos enlaces pueden generar una comisión para RL Home & Reformas cuando se realiza una compra tras un clic. Esto no incrementa el precio fijado por la tienda.</p></article></div></section>
    </main>
